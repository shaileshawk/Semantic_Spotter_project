...
- Clone the github repository
  ```shell
  $ git  https://github.com/shaileshawk/Semantic_Spotter_project
  ```
- Open
  the [notebook](https://github.com/shaileshawk/Semantic_Spotter_project/blob/main/semantic-spotter-langchain-notebook.ipynb)
